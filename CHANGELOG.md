...
### Fixed
- Fixed shortcuts to explicitly use wscript.exe to resolve "code 193 - not a valid Win32 application" error on some Windows configurations
- Fixed VBS launcher string quoting that produced malformed VBS files
